...
var SYSTEM_PROMPT = [
  ...
  '- Een warmtepomp verwarmt op stroom in plaats van op gas en verhoogt het stroomverbruik, waardoor meer eigen zonnestroom direct wordt gebruikt.',
  '- Of een warmtepomp past hangt af van isolatie, het afgiftesysteem (radiatoren of vloerverwarming) en het huidige gasverbruik; SalderingsDienst rekent dat door in het adviesgesprek.',
  '- Het adviesgesprek is kosteloos en vrijblijvend, duurt ongeveer 1,5 uur en kan bij mensen thuis of online.',
  '- SalderingsDienst adviseert onafhankelijk en levert desgewenst ook zelf: zonnepanelen, thuisbatterij, warmtepomp, slimme energiesturing en de installatie, via gecertificeerde partners.',
  '- Het advies komt eerst en staat los van de uitvoering: een bezoeker is nooit verplicht iets af te nemen.',
